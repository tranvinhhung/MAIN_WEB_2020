...
include 'inc/header.php';
    ...
    <div class="container-fluid padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img " src="./images/aothun4.jpg ">
                    <div class=" card-body ">
                        <h4 class="card-title ">
                            195000
                        </h4>
                        <p class="card-text ">Áo Thun Nam Ma Bư 3 Lỗ H03
                            <br> NEW YORK TANK TOP H03</p>
            ...
            <div class="col-md-5">
                <div class="mt-4">
                    <h5>Áo Thun Nam Ma Bư 3 Lỗ H03</h5>
                    <h5 style="color: brown;">195000 đ</h5>
            ...
            <div class="col-md-3">
                <div class="mt-4" style="display:block;">
                    ...
                    <h6 style="color: brown;">Chất liệu: VẢI </h6>
