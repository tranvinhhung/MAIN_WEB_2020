...
?>
    ...
    <div class="container-fluid padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img " src="./images/aosm2.jpg ">
                    <div class=" card-body ">
                        <h4 class="card-title ">
                            325000
                        </h4>
                        <p class="card-text ">Sơ Mi Nam No Style TD X01</p>
            ...
            <div class="col-md-5">
                <div class="mt-4">
                    <h5>Sơ Mi Nam No Style TD X01</h5>
            ...
            <div class="col-md-3">
                <div class="mt-4" style="display:block;">
                    ...
                    <h6 style="color: brown;">Chất liệu: Kate Ấn Độ</h6>
