...
<div class="container-fluid padding">
	<div class="row padding" >
		<div class="col-md-4">
			<div class="card">
				<img class="card-img " src="./images/photomain5.jpg ">
				<div class=" card-body ">
					<h4 class="card-title ">
						350000
					</h4>
					<p class="card-text ">Sơ Mi Nam Y2010 BD-A60</p>
        ...
        <div class="col-md-3">
            <div class="mt-4"style="display:block;">
               ...
               <h6 style="color: brown;">Chất liệu: YW 3782 -Trắng 17- nâu 3</h6>
               <h6 style="color: brown;">Thành phần : 65% Polyester 35% Cotton</h6>
               <h6 style="color: brown;">- Độ bền vải cao</h6>
               <h6 style="color: brown;">- Tính hút ẩm cao</h6>
               <h6 style="color: brown;">- Thoáng mát</h6>
