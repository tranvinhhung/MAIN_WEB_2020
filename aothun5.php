...
include 'inc/header.php';
    ...
    <div class="container-fluid padding">
        <div class="row padding">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img " src="./images/aothun5.jpg ">
                    <div class=" card-body ">
                        <h4 class="card-title ">
                            200000
                        </h4>
                        <p class="card-text ">Áo Thun Nam Basic AC03333</p>
            ...
            <div class="col-md-5">
                <div class="mt-4">
                    <h5>Áo Thun Basic AC033333</h5>
                    <h5 style="color: brown;">200000 đ</h5>
            ...
            <div class="col-md-3">
                <div class="mt-4" style="display:block;">
                    ...
                    <h6 style="color: brown;">Thành phần: 54%cotton 2%spandex 35% nilon</h6>
                    <h6 style="color: brown;">Cách nhiệt tốt, độ bền màu cao.</h6>
                    <h6 style="color: brown;"> hút ẩm tốt và thấm hút mồ hôi.</h6>
                    <h6 style="color: brown;">- Giặt ở chế độ bình thường, có thể giặt với xà bông nhá với đồ có màu tương tự.</h6>
