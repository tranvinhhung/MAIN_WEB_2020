...
<div class="container-fluid padding">
	<div class="row padding" >
		<div class="col-md-4">
			<div class="card">
				<img class="card-img " src="./images/hot9.jpg ">
				<div class=" card-body ">
					<h4 class="card-title ">
						385000
					</h4>
					<p class="card-text ">Áo Khoác Dù Có Nón Ma Bư KM04</p>
        ...
        <div class="col-md-5">
            <div class="mt-4">
               <h5>Áo Khoác Dù Có Nón Ma Bư KM04</h5>
               <h5 style="color: brown;">385000 đ</h5>
