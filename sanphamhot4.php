...
<div class="container-fluid padding">
	<div class="row padding" >
		<div class="col-md-4">
			<div class="card">
				<img class="card-img " src="./images/hot4.jpg ">
				<div class=" card-body ">
					<h4 class="card-title ">
						135000
					</h4>
					<p class="card-text ">Áo Thun Nam Y2010 Cổ Trụ C01</p>
        ...
        <div class="col-md-5">
            <div class="mt-4">
               <h5>Áo Thun Nam Y2010 Cổ Trụ C01</h5>
               <h5 style="color: brown;">135000 đ</h5>
