...
<div class="container-fluid padding">
	<div class="row padding" >
		<div class="col-md-4">
			<div class="card">
				<img class="card-img " src="./images/photomain6.jpg ">
				<div class=" card-body ">
					<h4 class="card-title ">
						255000
					</h4>
					<p class="card-text ">Sơ Mi Nam Y2010 Caro TD A05</p>
        ...
        <div class="col-md-5">
            <div class="mt-4">
               <h5>Sơ Mi Nam Y2010 Caro TD A05</h5>
               <h5 style="color: brown;">2550000 đ</h5>
        ...
        <div class="col-md-3">
            <div class="mt-4"style="display:block;">
               ...
               <h6 style="color: brown;">- Thấm hút ẩm tốt</h6>
