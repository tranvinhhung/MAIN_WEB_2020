...
<div class="container-fluid padding">
	<div class="row padding" >
		<div class="col-md-4">
			<div class="card">
				<img class="card-img " src="./images/photomain3.jpg ">
				<div class=" card-body ">
					<h4 class="card-title ">
						255000
					</h4>
					<p class="card-text ">Sơ Mi Nam Y2010 Caro TD A04</p>
        ...
        <div class="col-md-5">
            <div class="mt-4">
               <h5>Sơ Mi Nam Y2010 Caro TD A04</h5>
               <h5 style="color: brown;">255000 đ</h5>
